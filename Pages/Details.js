...
//   Burası validationları kontrol etmek içi yazılmış
  ...
  const postDatabase = async (e) => {
    ...
    if(checkBox){
        ...
        `${result.car_brand} araç markalı, ${result.car_model} modeline sahip, ${result.plate} plakalı, ${result.department} isimli birimin adına kayıtlı aracı, düzelterek ${newCar.car_brand} araç markalı, ${newCar.car_model} modeline sahip, ${newCar.plate} plakalı, ${newCar.department} isimli birimin adına kayıt etmek üzeresiniz onaylıyormusunuz?`)
        ...
        if(LastCheck){
            ...
            let message={};
            message.data= {log:`${user.username} kullanıcısı tarafından,${result.tracking_device_id} takip cihazı numaralı, ${result.belong_officer} kişisi üzerine kayıtlı, ${newCar.plate} plaka,  ${newCar.car_brand} marka , ${result.newCar} takip cihazı numarası, ${result.belong_officer} kişisi üzerine, ${newCar.plate} plakalı,  ${newCar.car_brand} marka ile güncelledi.`}
  ...
  return (
    <>
     <Header></Header>
        ...
        <h1 className='text-center'>Araç Bilgileri </h1>
            <h3 className='text-start'>Araç Bilgilerini Düzenle</h3>
            <hr/>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Row>
                    <Form.Group as={Col} md="12" >
                        <Form.Label >Araç Notu</Form.Label>
                            <Form.Control
                            type="text"
                            placeholder="Araç Notu"
                            name='notes'
                    ...
                    <Button type="submit" className='col-8 p-2 d-flex justify-content-center mx-auto' onClick={() => postDatabase(newCar)}>Düzenle</Button>
            </Form>
        </Container>
